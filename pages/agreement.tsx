...
const agreement = () => {
    return (
        <div className={styles.container} >
            ...
            <h3 className={styles.title} >제1조(목적)</h3>
            <ul className={styles.content} >
                <li>이 약관은 쇼핑냥이 회사(전자상거래 사업자)가 운영하는 쇼핑냥이 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.</li>
                <li>※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」</li>
            </ul>

            <h3 className={styles.title} >제2조(정의)</h3>
            <ul className={styles.content} >
                <li>“몰”이란 쇼핑냥이 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.</li>
            ...
            <h3 className={styles.title} >제3조 (약관 등의 명시와 설명 및 개정)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제4조(서비스의 제공 및 변경) </h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제5조(서비스의 중단)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제6조(회원가입)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제7조(회원 탈퇴 및 자격 상실 등)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제8조(회원에 대한 통지)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제9조(구매신청 및 개인정보 제공 동의 등) </h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제10조 (계약의 성립)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제11조(지급방법)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제12조(수신확인통지․구매신청 변경 및 취소)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제13조(재화 등의 공급)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제14조(환급)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제15조(청약철회 등)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제16조(청약철회 등의 효과)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제17조(개인정보보호)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제18조(“몰“의 의무)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제19조(회원의 ID 및 비밀번호에 대한 의무)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제20조(이용자의 의무)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제21조(연결“몰”과 피연결“몰” 간의 관계)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제22조(저작권의 귀속 및 이용제한)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제23조(분쟁해결)</h3>
            <ul className={styles.content} >
            ...
            <h3 className={styles.title} >제24조(재판권 및 준거법)</h3>
            <ul className={styles.content} >
